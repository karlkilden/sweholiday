...
/**
 * {@link CachingSweHolidayChecker} is not currently not in use pending cache eviction strategy during production.
 * But using {@link SweHolidayCheckerTest#perf()} A  performance enhancement could be noted (60% on my machine).
 ...
 */
class CachingSweHolidayCheckerTest {
    SweHolidayCheckerMock mock = new SweHolidayCheckerMock();
    CachingSweHolidayChecker chc = new CachingSweHolidayChecker(mock);
